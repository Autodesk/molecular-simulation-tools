...
const mockedAppStatus = {
  ...
  jobResult: {
    definition: {
      ...
      image: {
        optionsCreate: {
          ...
          Env: [
            'CCC=ccc.lifesciences.autodesk.com:9000',
            'INPUTS=/inputs',
            'OUTPUTS=/outputs',
    ...
    stdout: [
      ...
      'Using CCC server: ccc.lifesciences.autodesk.com:9000',
      ...
      '',
      'Running task \'prep_ligand\' on CloudComputeCannon engine on host: http://ccc.lifesciences.autodesk.com:9000/',
      '  jobid: r1TpyPZTg',
      ...
      '',
      '',
      'Running task \'prep_forcefield\' on CloudComputeCannon engine on host: http://ccc.lifesciences.autodesk.com:9000/',
      '  jobid: rya1ewW6l',
      '  image: docker.io/avirshup/mst:mdt_ambertools-0.0.1b6',
      '  command: python2 run_job.py',
      '  input_fields:',
      ...
      '',
      '',
      'Running task \'mm_minimization\' on CloudComputeCannon engine on host: http://ccc.lifesciences.autodesk.com:9000/',
      '  jobid: B1fbxDZae',
